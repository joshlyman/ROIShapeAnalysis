...
outcsv = '/Users/yanzhexu/Desktop/Research/ShapeDescriptors_51_malignant.csv'
...
with open(outcsv, 'wb') as CSVFile:
    ...
    for casefile in os.listdir(filename):
        ...
        for dicomfile in os.listdir(filename2):
            ...
            patientID = dicomfile.split('.')[0].split('-')[0]
            phasename = dicomfile.split('.')[0].split('-')[1] + dicomfile.split('.')[0].split('-')[2]
            print dicomfile
            # print sample
